...
class Kg extends Regex
{
    ...
    protected array $blockItems = [
        1 => [ '/pid:(?>[\x20\t]*)(.+)$/im'     => 'contacts:admin:handle',
        ...
        2 => [ '/pid:(?>[\x20\t]*)(.+)$/im'     => 'contacts:tech:handle',
        ...
        3 => [ '/pid:(?>[\x20\t]*)(.+)$/im'                   => 'contacts:billing:handle',
        ...
        4 => [ '/record created:(?>[\x20\t]*)(.*?)$/im'         => 'created',
     ...
     */
    protected ?string $available = '/Data not found/i';
