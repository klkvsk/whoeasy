...
class Hm extends Regex
{
    ...
    protected array $blockItems = [
        1 => [ '/Domain Registrant:(?>[\x20\t]*)(.*?)$/is' => 'contacts:owner:address' ],
        2 => [ '/Adminstrative Contact:(?>[\x20\t]*)(.*?)$/is' => 'contacts:admin:address' ],
        3 => [ '/Technical Contact:(?>[\x20\t]*)(.*?)$/is' => 'contacts:tech:address' ],
        4 => [ '/Billing Contact:(?>[\x20\t]*)(.*?)$/is' => 'contacts:billing:address' ],
        5 => [ '/Name Server:(?>[\x20\t]*)(.*?)$/im' => 'nameserver' ],
        6 => [ '/Domain creation date:(?>[\x20\t]*)(.*?)$/im'   => 'created',
