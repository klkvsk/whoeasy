...
class Il extends Regex
{
     ...
     * @var array
     */
    protected array $blocks = [ 1 => '/query:(?>[\x20\t]*)(.*?)(?=changed)/is',
    ...
    protected array $blockItems = [
        1 => [ '/descr:(?>[\x20\t]*)(.+)$/im'    => 'contacts:owner:address',
        ...
        3 => [ '/registrar name:(?>[\x20\t]*)(.+)$/im' => 'registrar:name',
               '/registrar info:(?>[\x20\t]*)(.+)$/im' => 'registrar:url' ] ];

    /**
     * RegEx to check availability of the domain name
     */
    protected ?string $available = '/No data was found to match/i';
