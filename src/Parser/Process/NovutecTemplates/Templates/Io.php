...
class Io extends Regex
{
     ...
     * @var array
     */
    protected array $blocks = [ 1 => '/Domain Information(.*?)(?=Domain Owner)/is',
    ...
    protected array $blockItems = [
        ...
        2 => [ '/User ID\s*:(?>[\x20\t]*)(.+)/i'           => 'contacts:owner:handle',
        ...
        3 => [ '/User ID\s*:(?>[\x20\t]*)(.+)/i'           => 'contacts:admin:handle',
        ...
        4 => [ '/User ID\s*:(?>[\x20\t]*)(.+)/i'           => 'contacts:tech:handle',
        ...
        5 => [ '/User ID\s*:(?>[\x20\t]*)(.+)/i'           => 'contacts:billing:handle',
        ...
        6 => [ '/User ID\s*:(?>[\x20\t]*)(.+)/i'           => 'registrar:id',
        ...
        7 => [ '/Name Server\s*:(?>[\x20\t]*)(.+)/i' => 'nameserver',
