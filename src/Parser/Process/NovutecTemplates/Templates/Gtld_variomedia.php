...
class Gtld_variomedia extends Regex
{
     ...
     * @var array
     */
    protected array $blocks = [ 1 => '/\[Registrant\](.*?)(?=\[Admin\])/is',
                                2 => '/\[Admin\](.*?)(?=\[Tech\])/is',
    ...
    protected array $blockItems = [
        1 => [ '/^Organization:(?>[\x20\t]*)(.+)$/im'      => 'contacts:owner:organization',
        ...
        2 => [ '/^Organization:(?>[\x20\t]*)(.+)$/im'      => 'contacts:admin:organization',
        ...
        3 => [ '/^Organization:(?>[\x20\t]*)(.+)$/im'      => 'contacts:tech:organization',
