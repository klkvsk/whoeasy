...
class Krnic extends Regex
{
     ...
     * @var array
     */
    protected array $blocks = [ 1 => '/(\[ Network Information \])[\n]{1}(.*?)[\n]{2}/is',
    ...
    protected array $blockItems = [
        1 => [ '/^IPv4 Address[\s]*:[\s]*(.+)$/im'      => 'network:inetnum',
