 ...
 *
 * @package Klkvsk\Whoeasy\Parser\Process\NovutecTemplates\Templates
 */
class Standard extends KeyValue
{
    ...
    protected ?string $available = '/(Status: free|No match|No Object Found|Domain not found|Domain Status: Available)/i';
