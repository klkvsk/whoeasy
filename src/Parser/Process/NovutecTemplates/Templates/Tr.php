...
class Tr extends Regex
{
     ...
     * @var array
     */
    protected array $blockItems = [ 1 => [ '/registrant:\n(.+)$/is' => 'contacts:owner:address' ],
                                    2 => [ '/nic handle(?>[\x20\t]*): (.+)$/im'        => 'contacts:admin:handle',
                                    ...
                                    3 => [ '/nic handle(?>[\x20\t]*): (.+)$/im'        => 'contacts:tech:handle',
                                    ...
                                    4 => [ '/nic handle(?>[\x20\t]*): (.+)$/im'        => 'contacts:billing:handle',
                                    ...
                                    5 => [ '/\n(?>[\x20\t]*)(.+)$/im' => 'nameserver' ],
                                    6 => [ '/created on(?>[\.]*): (.+)$/im' => 'created',
                                           '/expires on(?>[\.]*): (.+)$/im' => 'expires' ] ];

    /**
     * RegEx to check availability of the domain name
     */
    protected ?string $available = '/No match found for/i';
