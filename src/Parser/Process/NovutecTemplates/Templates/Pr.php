...
class Pr extends Regex
{
    ...
    protected array $blockItems = [
        ...
        2 => [ '/Organization:(?>[\x20\t]*)(.+)$/im'   => 'contacts:owner:organization',
        ...
        3 => [ '/Organization:(?>[\x20\t]*)(.+)$/im'   => 'contacts:admin:organization',
        ...
        4 => [ '/Organization:(?>[\x20\t]*)(.+)$/im'   => 'contacts:tech:organization',
        ...
        5 => [ '/Organization:(?>[\x20\t]*)(.+)$/im'   => 'contacts:billing:organization',
        ...
        6 => [ '/DNS:(?>[\x20\t]*)(.+)$/im' => 'nameserver' ] ];

    /**
     * RegEx to check availability of the domain name
     */
    protected ?string $available = '/is not registered./i';
}