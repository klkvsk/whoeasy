...
class Int_ extends Regex
{
     ...
     * @var array
     */
    protected array $blocks = [ 1 => '/organisation:(?>[\x20\t]*)(.*?)(?=contact:)/is',
    ...
    protected array $blockItems = [
        1 => [ '/organisation:(?>[\x20\t]*)(.+)$/im' => 'contacts:owner:organization',
               '/address:(?>[\x20\t]*)(.+)$/im'      => 'contacts:owner:address' ],
        2 => [ '/name:(?>[\x20\t]*)(.+)$/im'         => 'contacts:admin:name',
        ...
        4 => [ '/nserver:(?>[\x20\t]*)([a-z0-9\.]*) [a-z0-9\.\:]*/im' => 'nameserver',
     ...
     */
    protected ?string $available = '/but this server does not have/i';
}