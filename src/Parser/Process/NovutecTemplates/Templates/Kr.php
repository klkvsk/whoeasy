...
class Kr extends Regex
{
    ...
    protected array $blockItems = [
        1 => [ '/^Registrant(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im'          => 'contacts:owner:name',
        ...
        3 => [ '/^Registered Date(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im'         => 'created',
        ...
        4 => [ '/(?>[\x20\t]*)Host Name(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'nameserver' ] ];

    /**
     * RegEx to check availability of the domain name
     */
    protected ?string $available = '/Above domain name is not registered/i';
