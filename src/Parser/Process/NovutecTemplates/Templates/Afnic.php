...
class Afnic extends Regex
{
     ...
     * @var array
     */
    protected array $blocks = [ 1 => '/domain:(?>[\x20\t]*)(.*?)(?=ns-list)/is',
    ...
    protected array $blockItems = [
        ...
        3 => [ '/^nic-hdl:(?>[\x20\t]*)(.+)$/im'    => 'contacts:handle',
        ...
        4 => [ '/^key1-tag:(?>[\x20\t]*)(.+)$/im' => 'dnssec' ],

        5 => [ '/^registrar:(?>[\x20\t]*)(.+)$/im' => 'registrar:name',
     ...
     */
    protected ?string $available = '/(%% No entries found in the AFNIC Database.)[\r\n]/i';
