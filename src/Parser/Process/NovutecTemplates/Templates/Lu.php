...
class Lu extends Regex
{
     ...
     * @var array
     */
    protected array $blocks = [ 1 => '/domainname:(?>[\x20\t]*)(.*?)(?=org-name:)/is',
    ...
    protected array $blockItems = [
        ...
        2 => [ '/^org-name:(?>[\x20\t]*)(.+)$/im'    => 'contacts:owner:name',
        ...
        3 => [ '/^adm-name:(?>[\x20\t]*)(.+)$/im'    => 'contacts:admin:name',
        ...
        4 => [ '/^tec-name:(?>[\x20\t]*)(.+)$/im'    => 'contacts:tech:name',
        ...
        5 => [ '/^registrar-name:(?>[\x20\t]*)(.+)$/im'  => 'registrar:name',
     ...
     */
    protected ?string $available = '/No such domain/i';
}