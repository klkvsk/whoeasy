...
class Im extends Regex
{
     ...
     * @var array
     */
    protected array $blockItems = [ 1 => [ '/name:(?>[\x20\t]*)(.+)$/im' => 'registrar:name' ],
                                    ...
                                    4 => [ '/name:(?>[\x20\t]*)(.+)$/im'     => 'contacts:billing:name',
                                           '/address\n(?>[\x20\t]*)(.+)$/is' => 'contacts:billing:address' ],
                                    5 => [ '/name:(?>[\x20\t]*)(.+)$/im'     => 'contacts:tech:name',
                                           '/address\n(?>[\x20\t]*)(.+)$/is' => 'contacts:tech:address' ],
                                    6 => [ '/expiry date:(?>[\x20\t]*)(.+)$/im' => 'expires' ],
                                    7 => [ '/name server:(?>[\x20\t]*)(.+)\./im' => 'nameserver' ] ];
            ...
            foreach ($contactArray as $contactObject) {
                ...
                switch (sizeof($filteredAddress)) {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        $contactObject->address = [ $filteredAddress[0], $filteredAddress[1] ];
