...
class Tn extends Regex
{
     ...
     * @var array
     */
    protected array $blocks = [ 1 => '/Domain(?>[\x20\t]*):(?>[\x20\t]*)(.*?)(?=Owner Name)/is',
    ...
    protected array $blockItems = [
        ...
        3 => [ '/Admin\. Name(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im'    => 'contacts:admin:name',
        ...
        4 => [ '/Tech\. Name(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im'    => 'contacts:tech:name',
