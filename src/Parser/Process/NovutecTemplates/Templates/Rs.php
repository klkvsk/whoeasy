...
class Rs extends Regex
{
     ...
     * @var array
     */
    protected array $blocks = [ 1 => '/domain name:(?>[\x20\t]*)(.*?)(?=owner:)/is',
                                2 => '/owner:(?>[\x20\t]*)(.*?)(?=dns:)/is',
    ...
    protected array $blockItems = [
        ...
        2 => [ '/owner:(?>[\x20\t]*)(.+)$/im'   => 'contacts:owner:name',
               '/address:(?>[\x20\t]*)(.+)$/im' => 'contacts:owner:address' ],
        3 => [ '/dns:(?>[\x20\t]*)(.+)\. - .*$/im' => 'nameserver',
               '/dns:(?>[\x20\t]*).+\. - (.*)$/im' => 'ips' ],
        4 => [ '/administrative contact:(?>[\x20\t]*)(.+)$/im' => 'contacts:admin:name',
               '/address:(?>[\x20\t]*)(.+)$/im'                => 'contacts:admin:address' ],
        5 => [ '/technical contact:(?>[\x20\t]*)(.+)$/im' => 'contacts:tech:name',
               '/address:(?>[\x20\t]*)(.+)$/im'           => 'contacts:tech:address' ] ];

    /**
     * RegEx to check availability of the domain name
     */
    protected ?string $available = '/Domain is not registered/i';
