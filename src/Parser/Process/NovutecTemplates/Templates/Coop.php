...
class Coop extends Regex
{
     ...
     * @var array
     */
    protected array $blocks = [ 1 => '/Domain ID:(?>[\x20\t]*)(.*?)(?=Contact Type)/is',
    ...
    protected array $blockItems = [
        ...
        2 => [ '/Contact Type:(?>[\x20\t]*)(.+)$/im'    => 'contacts:reservedType',
        ...
        3 => [ '/Host Name:(?>[\x20\t]*)(.+)$/im' => 'nameserver' ] ];

    /**
     * RegEx to check availability of the domain name
     */
    protected ?string $available = '/No domain records were found to match/i';
