...
class Cd extends Regex
{
     ...
     * @var array
     */
    protected array $blocks = [ 1 => '/registrar:(?>[\x20\t]*)(.*?)(?=owner\/main Contact)/is',
    ...
    protected array $blockItems = [
        ...
        2 => [ '/name:(?>[\x20\t]*)(.+)\([0-9a-z\-]+\)/im'              => 'contacts:owner:name',
        ...
        3 => [ '/name:(?>[\x20\t]*)(.+)\([0-9a-z\-]+\)/im'              => 'contacts:admin:name',
        ...
        4 => [ '/name:(?>[\x20\t]*)(.+)\([0-9a-z\-]+\)/im'              => 'contacts:tech:name',
        ...
        5 => [ '/name:(?>[\x20\t]*)(.+)\([0-9a-z\-]+\)/im'              => 'contacts:billing:name',
